...
class TestFilesRoot(unittest.TestCase):  # pylint: disable=R0904
    ...
    def tearDown(self):  # pylint: disable=C0103
        """Delete the in-memory database"""
        real_db = self._db._get_full_content()  # pylint: disable=W0212
    ...
    # TODO: test all the functions pylint: disable=W0511
